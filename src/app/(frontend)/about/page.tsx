...
export const metadata: Metadata = {
  title: 'About — Ironside Customs',
  description: 'Hand-built motorcycles for riders who refuse to blend in.',
}
    ...
    <main className="bg-[linear-gradient(180deg,#f3efe4_0%,#f7edd9_28%,#ffffff_74%)]">
      ...
      <section className="container pb-16">
        <div className="relative aspect-[21/9] overflow-hidden rounded-2xl shadow-[0_25px_60px_rgba(35,24,15,0.15)]">
          <Image
            src="https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=1400&h=600&fit=crop"
            alt="Ironside Customs workshop"
            fill
