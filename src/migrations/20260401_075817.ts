...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_content_media" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_position" "enum_pages_blocks_content_media_media_position" DEFAULT 'right',
  	"rich_text" jsonb,
  	"media_id" integer,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_career_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_content_media" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"media_position" "enum__pages_v_blocks_content_media_media_position" DEFAULT 'right',
  	"rich_text" jsonb,
  	"media_id" integer,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "_pages_v_blocks_career_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "services_blocks_content_media" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_position" "enum_services_blocks_content_media_media_position" DEFAULT 'right',
  	"rich_text" jsonb,
  	"media_id" integer,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_services_v_blocks_content_media" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"media_position" "enum__services_v_blocks_content_media_media_position" DEFAULT 'right',
  	"rich_text" jsonb,
  	"media_id" integer,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "forms_blocks_h_captcha" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "forms_blocks_file" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "pages_blocks_content_media" ADD CONSTRAINT "pages_blocks_content_media_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_content_media" ADD CONSTRAINT "_pages_v_blocks_content_media_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_content_media_media_idx" ON "pages_blocks_content_media" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_content_media_media_idx" ON "_pages_v_blocks_content_media" USING btree ("media_id");
  ...
  CREATE INDEX "services_blocks_content_media_order_idx" ON "services_blocks_content_media" USING btree ("_order");
  ...
  CREATE INDEX "_services_v_blocks_content_media_order_idx" ON "_services_v_blocks_content_media" USING btree ("_order");
  ...
  CREATE INDEX "forms_blocks_h_captcha_order_idx" ON "forms_blocks_h_captcha" USING btree ("_order");
  CREATE INDEX "forms_blocks_h_captcha_parent_id_idx" ON "forms_blocks_h_captcha" USING btree ("_parent_id");
  CREATE INDEX "forms_blocks_h_captcha_path_idx" ON "forms_blocks_h_captcha" USING btree ("_path");
