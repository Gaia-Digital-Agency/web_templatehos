...
export default function ContactPage() {
  return (
    <main className="bg-[linear-gradient(180deg,#f3efe4_0%,#f7edd9_28%,#ffffff_74%)]">
      <Helmet>
        <title>Contact — Solace Wellness</title>
        <meta name="description" content="Reach out to begin your healing journey with Solace Wellness." />
      </Helmet>
      {/* Hero */}
      ...
      <section className="container pb-16">
        <div className="relative aspect-[21/9] overflow-hidden rounded-2xl shadow-[0_25px_60px_rgba(35,24,15,0.15)]">
          <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=1400&h=600&fit=crop" alt="Solace Wellness studio" className="object-cover absolute inset-0 w-full h-full" sizes="100vw" loading="lazy" decoding="async" />
        </div>
      </section>
