...
export default function CareersPage() {
  return (
    <main className="bg-[linear-gradient(180deg,#f3efe4_0%,#f7edd9_28%,#ffffff_74%)]">
      <Helmet>
        <title>Careers — Meridian Travel Co.</title>
        <meta name="description" content="Join the team that turns dream trips into real itineraries." />
      </Helmet>
      {/* Hero */}
      ...
      <section className="container pb-16">
        <div className="relative aspect-[21/9] overflow-hidden rounded-2xl shadow-[0_25px_60px_rgba(35,24,15,0.15)]">
          <img src="https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=1400&h=600&fit=crop" alt="Meridian Travel team" className="object-cover absolute inset-0 w-full h-full" sizes="100vw" loading="lazy" decoding="async" />
        </div>
      </section>
