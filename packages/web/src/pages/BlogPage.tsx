...
export default function BlogPage() {
  return (
    <main className="bg-[linear-gradient(180deg,#f3efe4_0%,#f7edd9_28%,#ffffff_74%)]">
      <Helmet>
        <title>Blog — NeuralArc</title>
        <meta name="description" content="Insights on AI, machine learning, and the future of intelligent systems." />
      </Helmet>
      {/* Hero */}
      ...
      <section className="container pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 rounded-2xl border border-[#d6c5a8]/50 bg-white/60 overflow-hidden shadow-[0_25px_60px_rgba(35,24,15,0.1)]">
          <div className="relative aspect-video lg:aspect-auto">
            <img src={featuredPost.image} className="object-cover absolute inset-0 w-full h-full" sizes="(max-width: 1024px) 100vw, 50vw" loading="lazy" decoding="async" />
          </div>
          ...
          {posts.map((post) => (
            ...
            >
              <div className="relative aspect-video">
                <img src={post.image} className="object-cover absolute inset-0 w-full h-full" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw" loading="lazy" decoding="async" />
              </div>
