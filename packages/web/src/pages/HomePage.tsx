...
export const HomePage: React.FC = () => {
  return (
    <main className="bg-[linear-gradient(180deg,#f3efe4_0%,#f7edd9_28%,#ffffff_74%)]">
      <Helmet>
        <title>Templategen — AI Agent Showcase</title>
        <meta name="description" content="Victor manages email, schedules calendar events, publishes blog posts, analyses documents, and writes marketing copy." />
      </Helmet>
      ...
      <section className="container grid gap-10 py-16 md:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              to="/portfolio"
              className="inline-flex items-center justify-center rounded-md border border-[#1d140d] px-8 py-3 text-sm font-medium text-[#1d140d] hover:bg-[#f3efe4] transition-colors"
            >
              See Portfolio
            </Link>
          </div>
