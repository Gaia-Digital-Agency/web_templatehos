...
export default function PortfolioPage() {
  return (
    <main className="bg-[linear-gradient(180deg,#f3efe4_0%,#f7edd9_28%,#ffffff_74%)]">
      <Helmet>
        <title>Portfolio — Flavour Collective</title>
        <meta name="description" content="Showcasing our family of food & beverage brands across Southeast Asia." />
      </Helmet>
      {/* Hero */}
        ...
        <div className="flex flex-col gap-24">
          {brands.map((brand, i) => (
            ...
            >
              ...
              >
                <img src={brand.image} className="object-cover absolute inset-0 w-full h-full" sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" decoding="async" />
              </div>
            </div>
          ))}
        </div>
